      ...
      <section class="module">
        <div class="module-inner">
          <div class="side-bar ">
            ...
            <nav class="side-menu">
              <ul class="nav">
                <li><a href="userProfile.html"><span class="fa fa-user"></span> Thông tin</a></li>
                <li><a href="changePassword.html"><span class="fa fa-cog"></span> Thay Đổi Mật Khẩu</a>
                </li>

                <li class="active"><a href="historyBooking.html"><span class="fa fa-clock-o"></span>
                  Lịch Sử</a></li>
              </ul>
            </nav>
          </div>
              ...
              <div class="mb-8">
                <div class="mb-4">
                  ...
                  <div class="d-flex justify-content-end align-items-center">
                    <a href="reservationDetail.html" class="text-primary">Xem chi tiết</a>
                  </div>
                </div>
